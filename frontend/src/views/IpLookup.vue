...
<div class="result-row"><span class="label">省/州:</span><span>{{ result.region }}</span></div>
...
async function lookup() {
  ...
  try {
    ...
    if (!r.ok) { const e = await r.json(); error.value = e.error; return }
